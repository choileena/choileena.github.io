...
ivdose.out <- run_MedStrI(
    ...
    "\\1", rate)))),
    flow.columns = list(id='mod_id', datetime='Perform.Date', finalunits='final.units', unit='unit', rate='rate', weight='weight'),
    ...
    demo.list=NULL,
    demo.columns = list(id='mod_id', datetime='surgery_date', weight='weight'),
    missing.wgt.path = NULL,
    wgt.columns = list(id='mod_id', datetime='surgery_date', weight='weight'),
    check.path=checkDir, 
