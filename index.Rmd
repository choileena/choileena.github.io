...
Other data elements such as drug levels ([*Pro-Drug Level*](Pro-DrugLevel.html)), demographics ([*Pro-Demographic*](Pro-Demographic.html)), and laboratory data ([*Pro-Laboratory*](Pro-Laboratory.html)) can be processed using our system. These data can be combined with processed dose data to build PK/PD data using PK/PD data building modules (i.e., [*Build-PK-IV*](Build-PK-IV-simple.html), [*Build-PK-Oral*](Build-PK-Oral.html)). 
