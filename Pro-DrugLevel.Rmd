...
>>>>>>> 1984b9e1039245048558baeb56af83558d55415b
drugname <- 'fent'
LLOQ <- 0.05
```
...
conc.in <- read.csv(file.path(rawDataDir,"Concentration_DATA_simple.csv"),stringsAsFactors = FALSE)
head(conc.in,10)
...
conc.new <- dataTransformation(conc.in, rename = c('patient_id' = 'mod_id',
