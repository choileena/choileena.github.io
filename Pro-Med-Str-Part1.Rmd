...
* Raw IV dose data can come from two different data sources as described in [*Build-PK-IV* - Comprehensive](Build-PK-IV-comprehensive.html). In this tutorial, we use only one IV dose data called "MAR" and describe most relevant arguments to process this data. A detailed description of all arguments can be found in the manual of `run_MedStrI()`.
