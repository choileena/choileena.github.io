...
This tutorial describes how to use the *Extract-Med* module to obtain drug dosing information from unstructured clinical notes. The *Extract-Med* module uses a natural language processing (NLP) system called medExtractR.$^{2}$
...
```{r}
read.delim(system.file("examples", "lampid1_2016-02-05_note5_1.txt", package = "EHR"),header = FALSE)
```
